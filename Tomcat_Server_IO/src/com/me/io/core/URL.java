...
/**
 * <p><strong>com.me.io.core.URL</strong> is designed to provide public APIs for parsing
 * and synthesizing Uniform Resource Locators as similar as possible to the
 * APIs of <code>java.net.com.me.io.core.URL</code>, but without the ability to open a
 ...
 * available (such as an "https" com.me.io.core.URL when JSSE is not installed).</p>
 *
 * <p><strong>WARNING</strong> - This class assumes that the string
 * representation of a com.me.io.core.URL conforms to the <code>spec</code> argument
...
public final class URL implements Serializable {
    ...
    /**
     * Create a com.me.io.core.URL object from the specified String representation.
     *
     * @param spec String representation of the com.me.io.core.URL
     *
    ...
    /**
     * Create a com.me.io.core.URL object by parsing a string representation relative
     * to a specified context.  Based on logic from JDK 1.3.1's
     * <code>java.net.com.me.io.core.URL</code>.
     *
     * @param context com.me.io.core.URL against which the relative representation
     *  is resolved
     * @param spec String representation of the com.me.io.core.URL (usually relative)
     *
     * @exception MalformedURLException if the string representation
     *  cannot be parsed successfully
     */
    public URL(URL context, String spec) throws MalformedURLException {
        ...
        try {
            ...
            // Is this a ref relative to the context com.me.io.core.URL?
            ...
            if ((context != null) && ((newProtocol == null) ||
                ...
                // If the context is a hierarchical com.me.io.core.URL scheme and the spec
    ...
    /**
     * The authority part of the com.me.io.core.URL.
     */
    private String authority = null;


    /**
     * The filename part of the com.me.io.core.URL.
     */
    private String file = null;


    /**
     * The host name part of the com.me.io.core.URL.
     */
    private String host = null;


    /**
     * The path part of the com.me.io.core.URL.
     */
    private String path = null;


    /**
     * The port number part of the com.me.io.core.URL.
     */
    private int port = -1;


    /**
     * The protocol name part of the com.me.io.core.URL.
     */
    private String protocol = null;


    /**
     * The query part of the com.me.io.core.URL.
     */
    private String query = null;


    /**
     * The reference part of the com.me.io.core.URL.
     */
    private String ref = null;


    /**
     * The user info part of the com.me.io.core.URL.
     */
     ...
     * only if the argument is not null, and is a <code>com.me.io.core.URL</code> object
     * that represents the same <code>com.me.io.core.URL</code> as this object.  Two
     ...
     *
     * @param obj The com.me.io.core.URL to compare against
     */
    @Override
    ...
    /**
     * Return the authority part of the com.me.io.core.URL.
     */
    ...
    /**
     * Return the filename part of the com.me.io.core.URL.  <strong>NOTE</strong> - For
     * compatibility with <code>java.net.com.me.io.core.URL</code>, this value includes
    ...
    /**
     * Return the host name part of the com.me.io.core.URL.
     */
    ...
    /**
     * Return the path part of the com.me.io.core.URL.
     */
    ...
    /**
     * Return the port number part of the com.me.io.core.URL.
     */
    public int getPort() {
    ...
    /**
     * Return the protocol name part of the com.me.io.core.URL.
     */
    ...
    /**
     * Return the query part of the com.me.io.core.URL.
     */
    ...
    /**
     * Return the reference part of the com.me.io.core.URL.
     */
    ...
    /**
     * Return the user info part of the com.me.io.core.URL.
     */
     ...
     * portions of this com.me.io.core.URL.
     * <p>
     * <strong>NOTE</strong> - This method is not part of the public API
     * of <code>java.net.com.me.io.core.URL</code>, but is provided as a value added
        ...
        while (true) {
            ...
            if (index == 0)
                throw new MalformedURLException
                    ("Invalid relative com.me.io.core.URL reference");
     ...
     * if this <code>com.me.io.core.URL</code> and the <code>other</code> argument both refer
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("com.me.io.core.URL[");
        sb.append("authority=");
        sb.append(authority);
        sb.append(", file=");
        sb.append(file);
    ...
    /**
     * Parse the specified portion of the string representation of a com.me.io.core.URL,
