...
public class NioBlockingSelector {
    ...
    public void open(Selector selector) {
        ...
        poller.setName("com.me.io.core.NioBlockingSelector.BlockPoller-"+(++threadCounter));
        poller.start();
    }
            ...
            while (run) {
                try {
                    ...
                    while (run && iterator != null && iterator.hasNext()) {
                        ...
                        NioEndpoint.KeyAttachment attachment = (NioEndpoint.KeyAttachment)sk.attachment();
                        try {
                            attachment.access();
                            iterator.remove();
