...
public class JIoEndpoint extends AbstractEndpoint<Socket> {
    ...
    public interface Handler extends AbstractEndpoint.Handler {
         SocketState process(SocketWrapper<Socket> socket,
                                   SocketStatus status);

         void beforeHandshake(SocketWrapper<Socket> socket);
    }
            ...
            synchronized (socket) {
                try {
                    ...
                    if (state == AbstractEndpoint.Handler.SocketState.CLOSED) {
                        ...
                        socket.access();
                        launch = true;
                    } else if ((state == AbstractEndpoint.Handler.SocketState.OPEN) || (state == AbstractEndpoint.Handler.SocketState.UPGRADING)) {
                        socket.setKeptAlive(true);
                        socket.access();
                        launch = true;
                    } else {
