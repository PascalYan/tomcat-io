...
import com.me.io.util.ExceptionUtils;
import com.me.io.util.IntrospectionUtils;
import com.me.io.util.NioX509KeyManager;
import com.me.io.util.collections.SynchronizedQueue;
import com.me.io.util.collections.SynchronizedStack;
import com.me.io.util.compat.JreCompat;
import com.me.io.util.logging.Log;
import com.me.io.util.logging.LogFactory;
        ...
        private void close(NioChannel socket, SelectionKey key, SocketStatus socketStatus) {
            ...
            try {
                ...
                if (socket.getPoller().cancelledKey(key, socketStatus) != null) {
                    // com.me.io.core.SocketWrapper (attachment) was removed from the
